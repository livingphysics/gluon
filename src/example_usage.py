...
with Bioreactor(config) as reactor:
    ...
    jobs = [
        ...
        (create_control_co2_setpoint_job(10000, initial_delay=30, flush_multiplier=5e-4, tolerance_ppm=1000), 60, True)  # Control CO2 setpoint every 60s, offset by 30s, flush multiplier 5e-4, pauses when average within 1000ppm (default: 10000 ppm)
    ]
