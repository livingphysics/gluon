...
with Bioreactor(config) as reactor:
    ...
    jobs = [
        ...
        (partial(pid_co2_controller, setpoint_ppm=50000.0, pressurize_duration=5.0, pause=5.0, kp=0.00001, ki=0.00000005, kd=0.0), 30, True),  # Control CO2 every 30 seconds
    ]
