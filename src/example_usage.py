...
with Bioreactor(config) as reactor:
    ...
    jobs = [
        ...
        (create_control_co2_setpoint_job(10000, initial_delay=12, flush_multiplier=5e-4, pause_tolerance_ppm=500, resume_tolerance_ppm=1000), 30, True)  # Control CO2 setpoint every 30s, offset by 12s, flush multiplier 5e-4, pauses at 1000ppm, resumes at 2000ppm (default: 10000 ppm)
    ]
